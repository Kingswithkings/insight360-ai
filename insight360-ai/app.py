...
if analyze_button:
    ...
    st.download_button(
        ...
        data=pdf_report,
        file_name="insight360_analysis_report.pdf",
...
st.caption("Insight360 AI is an early prototype by 1stKings Ltd. Outputs should be reviewed by humans before decision-making.")